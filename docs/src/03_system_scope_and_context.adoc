...
| Web Front-End | Accessible via the internet, allowing users to interact with the KaW application. 
...
| Optional Features | KaW offers features such as internationalization, different game modes, and customizable parameters. 
|===