...
public class MusicSimulation extends Simulation {
  ...
  private ScenarioBuilder scn = scenario("MusicSimulation")
    .exec(
      http("request_0")
        .get("/")
        .headers(headers_0)
      ...
      http("request_6")
        ...
        .resources(
          http("request_7")
            ...
            .headers(headers_7)
            .body(RawFileBody("kaw/musicsimulation/0007_request.json"))
        ),
      pause(7),
      http("request_8")
